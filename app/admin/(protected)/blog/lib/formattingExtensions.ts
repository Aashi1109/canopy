        ...
        ? {
            color: {
              ...
              renderHTML: (attributes) =>
                typeof attributes.color === "string" && /^#[0-9a-f]{6}$/i.test(attributes.color)
                  ? {
                      "data-color": attributes.color.toLowerCase(),
                      style: `background-color: ${attributes.color.toLowerCase()}`,
                    }
                  : {},
            },
          }
