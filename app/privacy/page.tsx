...
const sections = [
  ...
  { title: "Cookies", body: "We use a small number of essential cookies for sessions, security, and preferences. With your permission, we also use optional analytics cookies. We do not use advertising cookies." },
